    ...
    def track_frame(self, frame):
        ...
        if self.first_frame:
            ...
            if ok:
                ...
                if(abs(objectcenter[1]-cameracenter[1])>(cameracenter[1]*0.25)):
                    
                    pitch=((objectcenter[1]-cameracenter[1])/(height/2))*-500+500
                    yaw = 300
                else:
                    pitch=500
                ...
                if(abs(objectcenter[0]-cameracenter[0])>(cameracenter[0]*0.15)):
                    roll=((objectcenter[0]-cameracenter[0])/(width/2))*1300
                    roll = max(min(1000, roll),-1000)
                    yaw = 300
                else:
                    roll=0
                    pass #print("x axis within 5%")
                
                print("yaw: "+str(yaw)+", roll: "+str(roll) +", pitch: "+str(pitch))
