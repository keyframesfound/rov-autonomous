    ...
    def track_frame(self, frame):
        ...
        if self.first_frame:            
            ...
            if ok:
                ...
                if(abs(objectcenter[0]-cameracenter[0])>(cameracenter[0]*0.05)):
                    yaw=((objectcenter[0]-cameracenter[0])/(width/2))*1000                    
                else:
                    yaw=0
                    pass #print("x axis within 5%")
                
                if(abs(objectcenter[1]-cameracenter[1])>(cameracenter[1]*0.05)):
                    pitch=((objectcenter[1]-cameracenter[1])/(height/2))*1000
                else:
                    pitch=0
