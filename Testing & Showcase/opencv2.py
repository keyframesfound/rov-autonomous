"""
In This file we showcase how to connect OpenCV and do object tracking withd ifferent tracking types // This is only a test
...
if __name__ == '__main__' :
    ...
    # Read video
    #object_tracking\highway.mp4"
    #video = cv2.VideoCapture(r"ball.mp4")
